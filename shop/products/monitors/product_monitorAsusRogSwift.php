...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/cubicgig/css/styles.css" />
                <meta charset="UTF-8">
		<title>Cubicle Gigglers - ASUS ROG SWIFT PG348Q</title>
	...
	<body>
		...
		?>
			...
			<ul id="breadcrumb">
                ...
                <li> <a href="product_monitorAsusMX279.php"> ASUS ROG SWIFT PG348Q </a> </li>
			</ul>
			<!-- END breadcrumbs -->
			...
			?>
			 ...
			 <!-- START Product description -->	
                         <div id="product_name">
                             <h2>ASUS ROG SWIFT PG348Q</h2>
                         </div>
                         <div id="product_picture">
                             <img src="/cubicgig/img/products/monitors/ASUSROGSWIFTPG348Q2.png"/>
                         </div>
                         <div id="product_description">
                             <p>34" IPS извит екран</p>
                          	 <p>Ultra-wide QHD (3440 x 1440)</p>
                             <p>NVIDIA G-SYNC</p>
                             <p>LED ефекти</p>
