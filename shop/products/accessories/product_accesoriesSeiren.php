...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/cubicgig/css/styles.css" />
                <meta charset="UTF-8">
		<title>Cubicle Gigglers - Razer Seiren Pro</title>
	...
	<body>
		...
		?>
			...
			<ul id="breadcrumb">
                ...
                <li> <a href="product_accesoriesSeiren.php"> Razer Seiren Pro</a> </li>
			</ul>
			<!-- END breadcrumbs -->
			...
			?>
			 ...
			 <!-- START Product description -->	
                         <div id="product_name">
                             <h2>Razer Seiren Pro</h2>
                         </div>
                         <div id="product_picture">
                             <img src="/cubicgig/img/products/accessories/Seiren2.png"/>
                         </div>
                         <div id="product_description">
                             <p>Висококачествен студиен запис</p>
                          	 <p>Кардиоид: стриймване, подкасти</p>
                             <p>Изход за слушалки за прецизен мониторинг</p>
