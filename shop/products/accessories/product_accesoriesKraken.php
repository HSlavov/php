...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/cubicgig/css/styles.css" />
                <meta charset="UTF-8">
		<title>Cubicle Gigglers - Razer Kraken USB</title>
	...
	<body>
		...
		?>
			...
			<ul id="breadcrumb">
                ...
                <li> <a href="product_accesoriesKraken.php"> Razer Kraken USB </a> </li>
			</ul>
			<!-- END breadcrumbs -->
			...
			?>
			 ...
			 <!-- START Product description -->	
                         <div id="product_name">
                             <h2>Razer Kraken USB</h2>
                         </div>
                         <div id="product_picture">
                             <img src="/cubicgig/img/products/accessories/kraken2.png"/>
                         </div>
                         <div id="product_description">
                             <p>Погалете слуха си</p>
                          	 <p>Потопете се напълно във виртуален съраунд звука</p>
                             <p>Персонализирайте звука</p>
