...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/cubicgig/css/styles.css" />
                <meta charset="UTF-8">
		<title>Cubicle Gigglers - Microsoft Office 365</title>
	...
	<body>
		...
		?>
			...
			<ul id="breadcrumb">
                ...
                <li> <a href="product_softuerOffice365.php"> Microsoft Office 365 </a> </li>
			</ul>
			<!-- END breadcrumbs -->
			...
			?>
			 ...
			 <!-- START Product description -->	
                         ...
                         <div id="product_picture">
                             <img src="/cubicgig/img/products/software/office3652.png"/>
                         </div>
                         <div id="product_description">
                             <p>абонамент за 1 година</p>
                          	 <p>за 1 PC/Mac + таблет</p>
                             <p>Рисувайте, пишете ръкописно, въвеждайте чрез клавиатурата </p>
                             <p>Компилирайте лесно приложение за бази данни в Access</p>
