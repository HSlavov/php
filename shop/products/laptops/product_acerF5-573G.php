...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/cubicgig/css/styles.css" />
                <meta charset="UTF-8">
		<title>Cubicle Gigglers - Acer Aspire F5-573G</title>
	...
	<body>
		...
		?>
			...
			<ul id="breadcrumb">
                ...
                <li> <a href="product_acerF5-573G.php"> Acer Aspire F5-573G </a> </li>
			</ul>
			<!-- END breadcrumbs -->
			...
			?>
			 ...
			 <!-- START Product description -->	
                         ...
                         <div id="product_picture">
                             <img src="/cubicgig/img/products/laptops/acerF5-573G2.png"/>
                         </div>
                         <div id="product_description">
                             <p>Intel Core i5-7200U (2-ядрен, 2.50 - 3.10 GHz, 3MB кеш)</p>
                             <p>NVIDIA GeForce GTX 950M (4GB)</p>
                             <p>1TB HDD (5400 оборотa/минута)</p>
                             <p>15.6-инчов (39.62 см.) - 1920x1080 (Full HD), матов</p>
                             <p>2.40 кг</p>
