...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/cubicgig/css/styles.css" />
                <meta charset="UTF-8">
		<title>Cubicle Gigglers - ASUS ROG G752VS</title>
	...
	<body>
		...
		?>
			...
			<ul id="breadcrumb">
                ...
                <li> <a href="product_asusrogg752vs.php"> ASUS ROG G752VS </a> </li>
			</ul>
			<!-- END breadcrumbs -->
			...
			?>
             ...
             <div id="product_name">
                 <h2>ASUS ROG G752VS</h2>
             </div>
             <div id="product_picture">
                 <img src="/cubicgig/img/products/laptops/AsusRogG752VS-GC118D2.png"/>
             </div>
             <div id="product_description">
                 <p>Intel Core i7-6700HQ</p>
                 <p>NVIDIA GeForce GTX 1070</p>
                 <p>16GB DDR4</p>
                 <p>256GB SSD NVMe + 1TB HDD</p>
                 <p>17.3-инчов (43.94 cм.) - 1920x1080 (Full HD), IPS матов</p>
